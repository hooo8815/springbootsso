...
//    }
    ...
    public static boolean checkPassword(String inPassword,String outPassword) {
        Md5Hash md5Hash = new Md5Hash(inPassword,inPassword,2019);
        if (md5Hash.toString().equals(outPassword)){
            return true;
        }
        return false;
    }
